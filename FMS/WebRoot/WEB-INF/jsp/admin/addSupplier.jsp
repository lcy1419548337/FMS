...
<form class="form-horizontal" id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/supplier_addSupplier">
	<div class="form-group">
    		<label class="col-sm-2 control-label" for="supplierId">供应商编号：</label>
    	<div class="col-sm-10">
    		<input class="form-control" type="text" name="supplierId" id="supplierId" placeholder="请输入供应商编号" />
    	</div>
  	...
  	<div class="form-group">
    	...
    	<div class="col-sm-10">
    		<input class="form-control" type="text" name="supplierName" id="supplierName" placeholder="请输入供应商名称" />
		</div> 
	</div>
	<div class="form-group">
    		<label class="col-sm-2 control-label" for="supplierLocation">供应商地址：</label>
    	<div class="col-sm-10">
		   <input size="16" type="text" value="" id="supplierLocation" class="form-control" name="supplierLocation" placeholder="请输入供应商地址">	
    	</div>
	</div>
    <div>
