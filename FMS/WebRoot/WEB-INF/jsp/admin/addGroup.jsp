...
<form class="form-horizontal" id="form1" name="form1" method="get" action="${pageContext.request.contextPath }/group_addToGroup">
	...
	<div class="form-group">
    	...
    	<div class="col-sm-10">
		   <input size="16" type="text" value="" id="form_datetime" class="form-control" name="TheTime">	
