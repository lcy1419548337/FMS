...
<script type="text/javascript">
	function change(){
		...
		img1.src="${pageContext.request.contextPath}/login_checkImage?"+new Date().getTime();
	}
</script>
  ...
  <body>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<form action="${pageContext.request.contextPath }/regist_adminRegist" method="get">
				<div class="form-group">
					 <label for="exampleInputEmail1">用户名</label><input type="text" id="adminName" name="adminname" class="form-control" onblur="checkAdminName()"/>
					 <s:fielderror fieldName="adminname"></s:fielderror>
					<span id="span1"></span>
				</div>
				 
				<div class="form-group">
					 <label for="exampleInputEmail1">密码</label><input type="password" id="password" name="password" class="form-control"/>
					<s:fielderror fieldName="password"></s:fielderror>
				</div>
				<div class="form-group">
					 <label for="exampleInputEmail1">确认密码</label><input type="password" name="rePassword" class="form-control" id="#" />
					 <s:fielderror fieldName="rePassword"></s:fielderror>
				</div>
				<div class="form-group">
					 <label for="exampleInputEmail1">Email address</label><input type="email" name="email" class="form-control" id="#" />
					 <s:fielderror fieldName="email"></s:fielderror>
				</div> 
				<div class="form-group">
					 <label for="exampleInputEmail1">手机号码</label><input type="phonenumber" name="phone" class="form-control" id="#" />
				</div> 
				<div class="form-group">
