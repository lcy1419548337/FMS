...
<script type="text/javascript">
    ...
    function showFeed() {
        ...
        var data = {"animalId":animalId , "startDate":startDate , "endDate":endDate , "feedId":feedId, "page":1};
        $.ajax({
            type : "get",
            async : false,  //同步请求
            url : url,
...
<script type="text/javascript">
    ...
    function showFeedByPage(thePage) {
        ...
        var feedId = $("#feedId").val();
        var url = "${pageContext.request.contextPath}/feed_showFeed";
        var data = {"animalId":animalId , "startDate":startDate , "endDate":endDate , "page":thePage , "feedId":feedId};
        $.ajax({
            type : "get",
            async : false,  //同步请求
            url : url,
    ...
    function testFeedId() {
        var obj = document.getElementById("feedId");
        alert(obj);
    }
</script>
...
<%--右侧--%>
          ...
          <div id="showForm" style="width: 1500px;height: 1000px;margin: auto">
