...
<%session.removeAttribute("refresh");%>
  ...
  <script type="text/javascript">
      function showFeed() {
          ...
          var url = "${pageContext.request.contextPath }/feed_findFeedInformation";
          var data = {"feedId":feedId , "feedCategory":feedCategory , "feedName":feedName , "suppliers":suppliers,"page":1};
          $.ajax({
              type : "get",
              async : false,  //同步请求
              url : url,
      ...
      function showFeedByPage(thePage) {
          ...
          //theForm.submit();
          var feedId=$("#feedId").val();
          var feedCategory=$("#theHide1").val();
          var feedName = $("#feedName").val();
          var suppliers = $("#suppliers").val();
          //var health = $("#health").val();

          var url = "${pageContext.request.contextPath }/feed_findFeedInformation";
          var data = {"feedId":feedId , "feedCategory":feedCategory , "feedName":feedName , "suppliers":suppliers,"page":thePage};
          $.ajax({
              type : "get",
              async : false,  //同步请求
              url : url,
	...
	<div class="row clearfix" style="width: 1500px;" align="center">
		<div class="col-md-12 column"style="width: 1500px;" align="center">

				   <label for="chooseCategory">选择饲料分类</label>
				   <input type="text" id="showCategory" width="10px" readonly="readonly">
				   		<input type="hidden" name="feedCategory" id="theHide1">
				...
				<s:iterator var="category" value="categories">
					<li>
						 <p id="${category.categoryId }" onclick="choose(this.id)">${category.categoryId }</p>
					</li>
				</s:iterator>	
				</ul>
				
			<label for="supplier">生产商名称</label>
				<input type="text" name="suppliers" id="suppliers">
			<label for="feedId">饲料编号</label>
				<input type="text" name="feedId" id="feedId">
			<label for="feedName">饲料名称</label>
				<input type="text" name="feedName" id="feedName">
				
			<label for="checkbox">查询全部饲料信息</label>
				<input type="radio" name="findAllOrNot" onMouseOver="chk=checked;" onClick="checked=chk=!chk;">
				<input type="button" value="开始查找" onclick="showFeed()">
...
&lt;%&ndash; 							<div style="float: right;width: 300px;height: 200px;background-color: #E8CCFF;color: #000000;display: block;" id="hideRemarks">
	  ...
	  <div id="showForm" style="width: 1500px;height: 1000px;margin: auto" align="center">
